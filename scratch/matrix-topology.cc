...
void printMST(int parent[], int n, vector<vector<bool> > graph)
{
printf("Edge Weight\n");
for (int i = 1; i < V; i++)
{
...
void primMST(vector<vector<bool> > graph)
{
...
int main (int argc, char *argv[])
{
  ...
  std::string adj_mat_file_name ("/home/sneha/repos/ns-3-allinone/ns-3-dev/scratch/adjacency_matrix.txt");
  std::string node_coordinates_file_name ("/home/sneha/repos/ns-3-allinone/ns-3-dev/scratch/node_coordinates.txt");
...
/*
   ...
   {
    anim.SetConstantPosition (nodes.Get(i), i, i);
